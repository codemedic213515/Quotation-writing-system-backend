...
public class QuotationService
{
    ...
    public async Task<List<object>> GetFormattedQuotationData(string quotationNumber)
    {
...
//         decimal laborRate = Convert.ToDecimal(rankMaster.LaborCostA ?? 0);
//         decimal overheadRate = Convert.ToDecimal(rankMaster.SiteMiscell ?? 0) / 100;
//         decimal miscellaneousRate = Convert.ToDecimal(rankMaster.OtherExpens ?? 0) / 100;
//         decimal generalExpensesRate = 0.1M;
...
//     /// <summary>
//     /// Safely converts a value to decimal, handling NULL and empty strings.
//     /// </summary>
//     private decimal SafeDecimal(object value)
//     {
//         if (value == null || string.IsNullOrWhiteSpace(value.ToString()))
//         {
//             return 0; // If NULL or empty, return 0
//         }
