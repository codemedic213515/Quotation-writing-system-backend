...
namespace QuotationWritingSystem.Controllers
{
    ...
    public class ABMaterialMasterController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ABMaterialMaster>>> GetABMaterialMasters()
        {
            return await _context.ABMaterialMasters.ToListAsync();
        }
        ...
        {
            var material = await _context.ABMaterialMasters.FindAsync(id);
            if (material == null)
            {
        ...
        {
            _context.ABMaterialMasters.Add(material);
        ...
        public async Task<IActionResult> UpdateABMaterialMaster(int id, [FromBody] ABMaterialMaster material)
        {
            ...
            var existingMaterial = await _context.ABMaterialMasters.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteABMaterialMaster(int id)
        {
            ...
            _context.ABMaterialMasters.Remove(material);
            await _context.SaveChangesAsync();
